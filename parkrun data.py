...
events = requests.get('http://images.parkrun.com/events.json').text.replace("\\u2019","'")
technical_event_info = requests.get('http://wiki.parkrun.com/index.php/Technical_Event_Information').text
cancellations = requests.get('http://wiki.parkrun.com/index.php/Cancellations/Global').text.replace("’","'")
